...
export const FelineProBNPDefinition: SNAPRowSelectionDeviceDefinition = {
  type: SNAPResultEntryType.RowSelection,
  ivlsAssay: "FelineProBNP",
  example: {
  ...
  rows: [
    {
      rowId: SnapResultTypeEnum.FELINE_FBNP_NORMAL,
      result: SnapResultTypeEnum.FELINE_FBNP_NORMAL,
      ivlsResult: "Normal",
      abnormal: false,
    ...
    {
      rowId: SnapResultTypeEnum.FELINE_FBNP_ABNORMAL,
      result: SnapResultTypeEnum.FELINE_FBNP_ABNORMAL,
      ivlsResult: "Abnormal",
      abnormal: true,
